...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="doctors.html">Therapists</a>
            </li>
            <li class="nav-item">
  ...
  <footer class="page-footer">
    <div class="container">
      ...
      <p id="copyright">Copyright &copy; 2022 Created by <a href="#_" target="_blank">Haspref Technologies</a>. All right reserved</p>
    </div>
  </footer>
